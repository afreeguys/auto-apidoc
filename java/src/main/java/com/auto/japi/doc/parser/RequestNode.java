...
public class RequestNode {
    ...
    private List<ClassNode> requestBodyNodes = new ArrayList<>();
    ...
    public void addRequestBodyNode(ClassNode classNode) {
        requestBodyNodes.add(classNode);
    }

    public List<ClassNode> getRequestBodyNodes() {
        return requestBodyNodes;
    }

    public void setRequestBodyNodes(List<ClassNode> requestBodyNodes) {
        this.requestBodyNodes = requestBodyNodes;
    }
